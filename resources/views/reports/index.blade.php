                            ...
                            <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <button onclick="showEmailModal({{ $report->id }}, '{{ $report->student->student_parent_email }}')" 
                                            class="bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white px-3 py-2 rounded-lg text-sm font-semibold transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center">
                                    ...
                                    <form method="post" action="{{ route('reports.generate-ai-single', $report->id) }}" class="inline">
                                        @csrf
                                        <button type="submit" 
                                                class="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-3 py-2 rounded-lg text-sm font-semibold transition-all duration-200 text-center shadow-md hover:shadow-lg flex items-center justify-center"
