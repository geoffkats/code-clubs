<x-layouts.app :title="__('Dashboard')">
            ...
            <div x-show="activeTab === 'overview'" class="space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-6">
                        ...
                        <div class="h-64">
                            <canvas id="attendanceChart"
                                    ...
                                    data-total='@json(array_column($weeklyAttendanceData ?? [], "total"))'></canvas>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-6">
                        ...
                        <div class="h-64">
                            <canvas id="clubPerformanceChart"
                                    data-labels='@json(array_column($monthlyClubPerformance ?? [], "name"))'
                                    data-attendance='@json(array_column($monthlyClubPerformance ?? [], "attendance_rate"))'></canvas>
                        </div>
                    </div>
                </div>
    ...
    <!-- Chart rendering is handled in resources/js/app.js via dynamic import -->
</x-layouts.app>
