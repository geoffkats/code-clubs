            ...
            <form method="POST" action="{{ route('admin.students.store') }}" class="p-6">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="student_id_number" class="block text-sm font-medium text-gray-700 mb-2">
                                Student ID Number *
                            </label>
                            <input type="text" 
                                   ...
                                   required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('student_id_number') border-red-300 @enderror"
